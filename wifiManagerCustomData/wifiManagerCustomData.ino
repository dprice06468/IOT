...
Serial.print("mqtt0: ");  Serial.println(mqtt_server); 
  ...
  //end read
Serial.print("mqtt1: ");  Serial.println(mqtt_server); 
  
  WiFiManagerParameter custom_output("output", "output", output, 2);
  WiFiManagerParameter custom_mqtt_server("server", "mqtt server", mqtt_server, 40);

Serial.print("mqtt2: ");  Serial.println(mqtt_server); 
  // WiFiManager
...
Serial.print("mqtt3: ");  Serial.println(mqtt_server); 
  ...
  wifiManager.autoConnect("wifiManagerCustomDataAP");
  // or use this for auto generated name ESP + ChipID
  //wifiManager.autoConnect();
  
  // if you get here you have connected to the WiFi
  Serial.println("Connected to wifi.");
Serial.print("mqtt4: ");  Serial.println(mqtt_server); 
  
  strcpy(output, custom_output.getValue());
  strcpy(mqtt_server, custom_mqtt_server.getValue());
Serial.print("mqtt5: ");  Serial.println(mqtt_server); 
